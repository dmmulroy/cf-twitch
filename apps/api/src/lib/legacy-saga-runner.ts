/**
 * LegacySagaRunner - Temporary compatibility runner for unmigrated saga Durable Objects
 *
...
/**
 * @deprecated Untyped retry scheduler retained for unmigrated saga runners.
 */
...
/**
 * @deprecated Temporary untyped persistence path for unmigrated sagas. Remove in issue #9.
 */
export class LegacySagaRunner {
	...
	async initSaga<P>(params: P): Promise<Result<void, SagaAlreadyExistsError | SagaRunnerDbError>> {
		...
		return Result.gen(async function* (this: LegacySagaRunner) {
