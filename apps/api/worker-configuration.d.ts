/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ae663646fab8bf88cdcd4092786f187a)
// Runtime types generated with workerd@1.20260120.0 2026-01-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpotifyTokenDO" | "TwitchTokenDO" | "StreamLifecycleDO" | "SongQueueDO" | "AchievementsDO" | "KeyboardRaffleDO" | "SongRequestSagaDO" | "KeyboardRaffleSagaDO" | "EventBusDO" | "CommandsDO" | "RaidShoutoutSagaDO" | "OAuthStateDO" | "EventSubWebhookDO";
	}
	interface Env {
		...
		TWITCH_BROADCASTER_NAME: string;
		SPOTIFY_CLIENT_ID: string;
		SPOTIFY_CLIENT_SECRET: string;
		OAUTH_SETUP_SECRET: string;
		ADMIN_SECRET: string;
		SPOTIFY_TOKEN_DO: DurableObjectNamespace<import("./src/index").SpotifyTokenDO>;
		TWITCH_TOKEN_DO: DurableObjectNamespace<import("./src/index").TwitchTokenDO>;
		STREAM_LIFECYCLE_DO: DurableObjectNamespace<import("./src/index").StreamLifecycleDO>;
		SONG_QUEUE_DO: DurableObjectNamespace<import("./src/index").SongQueueDO>;
		ACHIEVEMENTS_DO: DurableObjectNamespace<import("./src/index").AchievementsDO>;
		KEYBOARD_RAFFLE_DO: DurableObjectNamespace<import("./src/index").KeyboardRaffleDO>;
		SONG_REQUEST_SAGA_DO: DurableObjectNamespace<import("./src/index").SongRequestSagaDO>;
		KEYBOARD_RAFFLE_SAGA_DO: DurableObjectNamespace<import("./src/index").KeyboardRaffleSagaDO>;
		EVENT_BUS_DO: DurableObjectNamespace<import("./src/index").EventBusDO>;
		COMMANDS_DO: DurableObjectNamespace<import("./src/index").CommandsDO>;
		RAID_SHOUTOUT_SAGA_DO: DurableObjectNamespace<import("./src/index").RaidShoutoutSagaDO>;
		OAUTH_STATE_DO: DurableObjectNamespace<import("./src/index").OAuthStateDO>;
		EVENTSUB_WEBHOOK_DO: DurableObjectNamespace<import("./src/index").EventSubWebhookDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SONG_REQUEST_REWARD_ID" | "KEYBOARD_RAFFLE_REWARD_ID" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_ACCESS_TOKEN" | "TWITCH_REFRESH_TOKEN" | "TWITCH_EVENTSUB_SECRET" | "TWITCH_BROADCASTER_ID" | "TWITCH_BROADCASTER_NAME" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "OAUTH_SETUP_SECRET" | "ADMIN_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
