/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 345d8131f00cf4495659960889741602)
// Runtime types generated with workerd@1.20260120.0 2026-01-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpotifyTokenDO" | "TwitchTokenDO" | "StreamLifecycleDO" | "SongQueueDO" | "AchievementsDO" | "KeyboardRaffleDO" | "WorkflowPoolDO";
	}
	interface Env {
		...
		WORKFLOW_POOL_DO: DurableObjectNamespace<import("./src/index").WorkflowPoolDO>;
		SONG_REQUEST_WF: Workflow<Parameters<import("./src/index").SongRequestWorkflow['run']>[0]['payload']>;
		CHAT_COMMAND_WF: Workflow<Parameters<import("./src/index").ChatCommandWorkflow['run']>[0]['payload']>;
		KEYBOARD_RAFFLE_WF: Workflow<Parameters<import("./src/index").KeyboardRaffleWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SONG_REQUEST_REWARD_ID" | "KEYBOARD_RAFFLE_REWARD_ID" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_ACCESS_TOKEN" | "TWITCH_REFRESH_TOKEN" | "TWITCH_EVENTSUB_SECRET" | "TWITCH_BROADCASTER_ID" | "TWITCH_BROADCASTER_NAME" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "OAUTH_SETUP_SECRET">> {}
}
declare module "*.sql" {
	const value: string;
